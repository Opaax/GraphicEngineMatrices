...
//}
//
//Vector3 StaticMath::SubstractVectors(const Vector3& VecA, const Vector3& VecB)
//{
//    return Vector3(VecA.x - VecB.x, VecA.y - VecB.y, VecA.z - VecB.z);
//}
//
//Vector3 StaticMath::AddVectors(const Vector3& VecA, const Vector3& VecB, bool Normalized)
//{
//    return Vector3(VecA.x + VecB.x, VecA.y + VecB.y, VecA.z + VecB.z);
//}
//
